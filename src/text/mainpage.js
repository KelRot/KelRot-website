...
const kabatas = {
    t: '“Karanlığı Ezenlerin Lisesi” 1908 yılında kurulmuş Türkiye’nin en köklü, akademik ve sosyal alanlarda başarısıyla önde gelen okullarından biridir. Bu başarısının arkasında her şeyi planlayan disiplinli idarecileri, işiniz özveri ile yapan öğretmen kadrosu ve okulda her alanda faaliyetler yürütüp okuduğu okulun hakkını veren seçkin öğrenciler yer almaktadır.',
    l: 'https://kabataserkeklisesi.meb.k12.tr/tema/index.php'
};
...
const teknofest = {
    t: "Teknofest, Türkiye Teknoloji Takımı Vakfı (T3 Vakfı) ve T.C. Sanayi ve Teknoloji Bakanlığı’nın yürütücülüğünde, Türkiye’de milli teknolojinin geliştirilmesi konusunda kritik rol oynayan birçok kuruluşun paydaşlığıyla düzenlenen Türkiye'nin ilk ve tek havacılık, uzay ve teknoloji festivalidir.",
    l: 'https://www.teknofest.org/en/'
};
